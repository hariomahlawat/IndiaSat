...
def merge_prediction(monthly_pixel_predictions):    
    ...
    # Rule2: (pixel has been predicted as water and green atleast once)
    ...
    #Rule3: (Majority based selection between green and barrenland)
    elif (green_count >0 and barrenland_count>0):
    	#return '1'
    	return '1' if(green_count>=barrenland_count) else '4'
    # Rule4: (priority to Green and Water)	
    elif (green_count >0):
    	return '1'
    elif (water_count>0):
    	return '2'		        
