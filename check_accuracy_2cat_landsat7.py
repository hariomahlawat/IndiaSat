...
def main():
	...
	if choice == '1':
		...
		chosen_folder = input_folder + '/results/'+'combined_yearly_prediction_temp_corrected_temp_corrected'
		heading = '''
		-------------------------------------------------------------
		Temporal Correction on "Temp Corrected Rule based approach"
		Note : First temp correction was done on 5 years batches and 
		then second temp correction was done for all years.  
		-------------------------------------------------------------
		'''	
	else:
		print('''
